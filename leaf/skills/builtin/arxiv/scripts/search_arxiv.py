...
Usage:
    ...
    python3 skills/arxiv/scripts/search_arxiv.py "GRPO reinforcement learning" --max 10
    python3 skills/arxiv/scripts/search_arxiv.py "GRPO reinforcement learning" --sort date
    python3 skills/arxiv/scripts/search_arxiv.py --author "Yann LeCun" --max 5
    python3 skills/arxiv/scripts/search_arxiv.py --category cs.AI --sort date --max 10
...
def search(query=None, author=None, category=None, ids=None, max_results=5, sort="relevance"):
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'agentbob/1.0'})
